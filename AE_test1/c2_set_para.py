...
# OUTPUT1 = "result/classifier2_h242_1_mac.csv"
# OUTPUT2 = "result/classifier2_h363_2_mac.csv"
# OUTPUT_C = "result/classifier2_.csv"
# OUTPUT_C_ = "result/classifier2_histogram.csv"
...
with tf.name_scope('c2_classifier'):
...
# Validation------------------------------------------------------------------------------------------------------------
        ...
        print("finish C2 layer 1 operation.\ngo to C2 layer 2!")
# ------------ !! Layer 1 !! -------------------------------------------------------------------------------------------
...
# Validation------------------------------------------------------------------------------------------------------------
    ...
    print("finished learning classifier2!")
    return p
